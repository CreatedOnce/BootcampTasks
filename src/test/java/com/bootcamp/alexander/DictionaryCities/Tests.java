package com.bootcamp.alexander.DictionaryCities;

import com.bootcamp.alexander.dictionaryCities.model.City;
import com.bootcamp.alexander.dictionaryCities.service.*;
import com.bootcamp.alexander.dictionaryCities.util.Comparators;
import com.bootcamp.alexander.dictionaryCities.util.Algorithms;
...
public class Tests {
    ...
    private final String FILE_PATH = "src/main/resources/DictionaryCities.txt";
    ...
    public void shouldParseTest() {
        ...
        ParserCitites.parserCity(new File(FILE_PATH), expected);
    ...
    @Test
    public void findCityHighestPopulationTest() {
        int expected = Algorithms.findCityHighestPopulation(cities)[1];
    ...
    public void getCitiesNumberByRegionsTest() {
        ...
        Assert.assertEquals(expected, Algorithms.getCitiesNumberByRegion(cities));
    }
}
